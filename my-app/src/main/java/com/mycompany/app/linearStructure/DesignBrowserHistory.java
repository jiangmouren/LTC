...
//用一简单的Linear结构存History，只要注意一下ptr的manipulation
public class DesignBrowserHistory {
    List<String> history;
    int ptr;//永远指向当下visit的地址，而不是下一个
    ...
    public String back(int steps) {
        ...
        return this.history.get(ptr);
    }

    public String forward(int steps) {
        ptr = (ptr + steps)<this.history.size() ? ptr+steps : history.size()-1;
        return this.history.get(ptr);
    }
}
